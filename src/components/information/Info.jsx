...
export function Info() {
  return (
    <section id="information" className="">
      ...
      <h2 id="information-title" className="text-center pt-28 text-5xl">
        Information
      </h2>
      <div
        id="information-main"
      ...
      >
        <article className="text-center">
          <h2 id="information-main__title-my" className="text-4xl pt-14">
            About me
          </h2>
        ...
        <article id="information-main__title-skills" className="">
          <h2
            ...
            className="text-4xl pt-14 text-center"
          >
            Skills
          </h2>
          <div
            id="information-main__skills"
            className="grid grid-cols-3 justify-items-center gap-4 pt-10"
          >
            <Html height={"80"}/>
            <Css3 height={"80"}/>
            <Bootstrap height={"80"}/>
