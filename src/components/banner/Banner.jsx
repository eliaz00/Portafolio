    ...
    <section id="banner" className="banner">
      <figure className="container mx-auto">
        <img
          ...
          className="w-44 pt-12 mt-3"
          src={AstronautBall}
          alt="astronaut-ballons"
        />
      </figure>
      <article id="banner-main" className="">
        <div id="banner-title" className="">
          <div className="">
            <h1
              id="banner-title__welcome"
              className="lg:text-6xl md:text-5xl sm:text-5xl text-5xl text-white drop-shadow-2xl text-center"
            >
              I am Samuel Geraldino
            </h1>
            <p
              id="banner-title__developer"
              className="lg:text-7xl md:text-6xl sm:text-6xl text-6xl text-center drop-shadow-2xl"
            >
              junior web developer
            </p>
          </div>
          <div className="concept concept-eight mt-6 gap-1">
            ...
            <a
              ...
              href="https://drive.google.com/file/d/1nz5gDZ9TrI825tLPwfr0VUGezRq6Qdzm/view?usp=drive_link"
              target="_blanck"
            >
